...
public class TabContainer extends FrameLayout implements OnClickListener, OnTouchListener {
    ...
    private static final int[] sTabLabelRes = new int[]{R.string.feed_subscribed, R.string.addbybundlestitle, R.string.custom};
...
//        mSlideButton.setOnTouchListener(this);
    ...
    private void setNewIndex(){
        if(mOnTabChangeListener != null){
            mOnTabChangeListener.onTabChange(mTabButtons[mTabIndex].getId());
        }
    }
    @Override
