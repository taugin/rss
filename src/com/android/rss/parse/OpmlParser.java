    ...
    private void parse() {
        try {
            ...
            InputStream is = Thread.currentThread().getContextClassLoader()
                    .getResourceAsStream("sina_news_opml.xml");
            ...
            System.out.println("rootName : " + root.getNodeName());
            ...
            for (int i = 0; i < nodeList.getLength(); i++) {
                if (nodeList.item(i) instanceof Element) {
                    ...
                    if (!TextUtils.isEmpty(xmlUrl)) {
                        ...
                        values.put(Constant.Content.FEED_GUID,
                                String.valueOf(xmlUrl.hashCode()));
                        builder = ContentProviderOperation
                                .newInsert(Constant.Content.HISTORY_URI);
            ...
            try {
                mContext.getContentResolver().applyBatch(
                        Constant.Content.AUTHORITY, ops);
